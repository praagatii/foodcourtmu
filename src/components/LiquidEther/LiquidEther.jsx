  ...
  useEffect(() => {
    ...
    class CommonClass {
      constructor() {
        ...
        this.pixelRatio = 1; this.isMobile = false; this.breakpoint = 768;
        this.fboWidth = null; this.fboHeight = null; this.time = 0;
        this.delta = 0; this.container = null; this.renderer = null; this.clock = null;
      }
      init(container) {
    ...
    class MouseClass {
      constructor() {
        ...
        this.timer = null; this.container = null; this.docTarget = null;
        this.listenerTarget = null; this.isHoverInside = false;
        this.hasUserControl = false; this.isAutoActive = false;
        this.autoIntensity = 2.0; this.takeoverActive = false;
        this.takeoverStartTime = 0; this.takeoverDuration = 0.25;
    ...
    const webgl = new WebGLManager({
      $wrapper: container, autoDemo, autoSpeed, autoIntensity, takeoverDuration, autoResumeDelay, autoRampDuration
    });
    ...
    const io = new IntersectionObserver(entries => {
      ...
      if (!webglRef.current) return;
      if (isVisibleRef.current && !document.hidden) webglRef.current.start();
